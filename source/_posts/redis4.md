---
title: Redis | 7000字笔记总结，超详细！「转载」
date: 2020-04-29 11:31:54
categories:
- sql
- redis
- 基础
...
[Redis的7000字笔记总结，超详细！](https://mp.weixin.qq.com/s/nxA3VkvANCXkr14YcqUHnQ)
...
`string`4 是 redis 最基本的数据类型。一个 key 对应一个 value。
