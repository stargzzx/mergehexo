...
![](/images/deeplearning/0_35.png)

![](/images/deeplearning/0_36.png)
...
![](/images/deeplearning/0_4.png)

我们的目的是这个神经元是不是就是对应一个短边。每一条连接神经元的线都是一个权重。

![](/images/deeplearning/0_5.png)
...
![](/images/deeplearning/0_8.png)

我们只告诉训练模型有多糟糕是不行的，还得告知电脑如何去改变。

我们先以一元函数为例。

![](/images/deeplearning/0_9.png)
...
![](/images/deeplearning/0_10.png)

我们让小球进行滚动，但是，我们很容易陷入局部最小值。

![](/images/deeplearning/0_11.png)
