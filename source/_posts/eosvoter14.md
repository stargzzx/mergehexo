...
![](/images/eos_voter/14_0.png)

然后，使用 `chrome` 的开发者模式，查找到主页的排版是这样的：

![](/images/eos_voter/14_1.png)
...
[ChromDriver官网](https://sites.google.com/a/chromium.org/chromedriver/downloads)
...
[macbook | 更改系统级目录的权限](https://benpaodewoniu.github.io/2020/05/08/macbook10/)
...
- [python爬虫:使用Selenium模拟浏览器行为](https://www.cnblogs.com/sesshoumaru/p/python-selenium-webdriver.html)
